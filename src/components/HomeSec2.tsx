...
export default function HomeSec2() {
    return (
        <section className=" py-32  relative overflow-hidden  bg-color-very-dark-green">
            <div className="container lg:grid lg:grid-cols-2 lg:items-start">
                <MainArticle
                    subject="Build & manage distributed teams like no one else."
                    additionalStyleForPattern="bg-color-light-coral"
                    additionalStylesForPara="max-w-[60%] text-left text-[1.8rem] sm:text-[calc(1.8rem_+_1vw)] sm:max-w-[80%] leading-[2.2rem] lg:leading-[3rem] font-[700] mt-10 lg:mt-20"
                />
                <div
                    className=" absolute top-0 -right-[calc(18%_+_8vw)] sm:-right-[8%] 2xl:-right-[calc(6%_+_1vw)] 2xl:top-[60%]"
                    aria-hidden="true"
                >
                    <svg
                ...
                <ul className=" mt-14 flex flex-col  gap-y-8">
                    <li className=" flex flex-col items-center text-center md:items-start md:text-left lg:flex-row  lg:gap-x-8 lg:items-center">
                        <div>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="65"
                        ...
                        <article className="mt-5 flex flex-col gap-y-2">
                            <h2 className=" font-[700] text-color-light-coral text-[1.1rem]">
                                Experienced Individuals
                            </h2>
                            <p className=" text-white font-[600] md:max-w-[90%]">
