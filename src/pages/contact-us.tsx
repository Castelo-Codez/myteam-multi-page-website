...
const ContactUs: NextPageWithLayout = () => {
    return (
        <>
            <section className=" pt-16 pb-32 relative overflow-hidden   bg-color-midnight-green">
                <div
                    aria-hidden="true"
                    className=" hidden lg:block absolute top-14 left-[calc(-18%_+_1vw)] xl:left-[calc(-15%_+_1vw)]  2xl:left-[calc(-10%_+_5vw)]"
                >
                    <svg
                ...
                <div className=" container grid grid-cols-1 gap-y-20 lg:grid-cols-2 lg:items-center">
                    <section className="left-layer flex flex-col gap-y-10">
                        <h2 className=" relative z-10 text-center lg:text-left  text-color-white font-[700] text-[3rem] lg:text-[4rem]  ">
                            Contact
                        </h2>
                        <h3 className="relative z-10 text-[2.1rem] mt-[-3rem] lg:mt-[-1.5rem]  text-color-light-coral font-[700] text-center lg:text-left">
                            Ask us about
                        </h3>
                        <ul className=" flex flex-col gap-y-8 ">
                            <li className=" flex flex-col gap-y-3  items-center lg:flex-row lg:gap-x-4 ">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="65"
                                    height="72"
                                ...
                                <p className=" text-center text-[1.2rem] font-[700] text-color-white">
                ...
                <div
                    aria-hidden="true"
                    className=" absolute -bottom-[10%] -right-[10%] lg:-bottom-[5%] lg:-right-[5%]"
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="201"
